export const API_URL = {
  ...
  userLoginUrl: 'https://vueBlog.livenotice.co.uk/api/login.php',
  deleteBlogUrl: 'https://vueBlog.livenotice.co.uk/api/delete.php?id=',
  updateBlogUrl: 'https://vueBlog.livenotice.co.uk/api/update.php',
  postFormDataUrl: 'https://vueBlog.livenotice.co.uk/api/sendMe.php',
};
